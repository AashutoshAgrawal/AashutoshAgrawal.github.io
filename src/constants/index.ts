...
export const socialLinks = {
  ...
  linkedin: "https://linkedin.com/in/aashutoshagrawal",
...
export const projectsData = {
  ...
  subtitle: "Products and initiatives I've built",
  projects: [
    {
      id: 1,
      title: "DiaBeat - AI Insulin Calculator",
      description: "AI-powered insulin dosing assistant for Type 1 diabetics with meal logging, dose calculator, safety guardrails, and CGM integration.",
      longDescription: "Interviewed 14+ Type 1 diabetics to identify pain points in carb counting and insulin management. Built a working prototype and validated through usability testing, gaining pilot interest from clinics.",
      image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop",
      tags: ["Lovable", "AI/ML", "Healthcare", "User Research", "Prototyping"],
      category: "Startup",
      featured: true,
      liveDemoLink: "",
      sourceCodeLink: "",
      highlights: [
        ...
        "AI-powered dose calculations",
        "Safety guardrails built-in",
        "Clinic pilot interest secured",
      ],
    },
    {
      id: 2,
      title: "HelpHive - Community Handyman Services",
      description: "Community-driven marketplace connecting people with trusted local handymen for quick, affordable home services.",
      longDescription: "Interviewed 25+ users (students, professionals, retirees) to identify gaps in handyman services. Designed MVP with task posting, real-time chat, payments, and trust badges.",
      image: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&h=600&fit=crop",
      tags: ["Product Strategy", "MVP Design", "User Research", "Figma", "PRD"],
      category: "Startup",
      featured: true,
      ...
      highlights: [
        ...
        "Positioned for pilot adoption",
      ],
    },
    {
      id: 3,
      title: "Grad Planner - ML Class Planning",
      description: "Machine learning algorithm that automates the class planning process for students and helps universities make data-driven course planning decisions.",
      longDescription: "From initial prototype to final launch, led Grad Planner through several product cycles. Built an algorithm that automates class planning for students while gathering data to help universities optimize course offerings.",
      image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=600&fit=crop",
      tags: ["Machine Learning", "Product Management", "Agile", "User Research", "Education Tech"],
      category: "Startup",
      featured: true,
      liveDemoLink: "",
      sourceCodeLink: "",
      highlights: [
        "7,000+ course plans created monthly",
        "97% of SCU students used in first month",
        "84% say experience 'vastly improved'",
    ...
    },
    {
      ...
      description: "Built and optimized VR-based compliance training at SISU VR, increasing product effectiveness from 42% to 94% through user research and A/B testing.",
      longDescription: "At SISU VR, I helped reinvent compliance training using virtual reality. Through competitive analysis, market research, and A/B testing, I identified and implemented feature changes that dramatically improved learning outcomes and behavioral compliance.",
      image: "https://images.unsplash.com/photo-1622979135225-d2ba269cf1ac?w=800&h=600&fit=crop",
      tags: ["VR", "Product Management", "User Research", "A/B Testing", "EdTech"],
      category: "Internship",
      featured: true,
      liveDemoLink: "",
      sourceCodeLink: "",
      highlights: [
        "Increased effectiveness from 42% to 94%",
