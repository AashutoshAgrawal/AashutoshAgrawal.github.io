...
export const projectsData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "Built and deployed an AI agent that converts any blog post into a podcast using Google Gemini. Identified user pain point (content consumption on-the-go) and shipped zero-friction solution.",
      longDescription: "Identified opportunity: Busy professionals want to consume written content while commuting but lack time to read. Built end-to-end AI agent pipeline: Firecrawl web scraping → Gemini summarization → Gemini text-to-speech. Key PM decisions: (1) Deployed on Streamlit for zero-setup user experience vs. requiring local installation. (2) Used Google Gemini for both summarization + TTS to simplify architecture (single API vs. multiple integrations). (3) Focused on speed: <30 second generation time from URL input to downloadable podcast. Product enables content accessibility and reaches audio-first audiences.",
      image: "https://images.unsplash.com/photo-1590602847861-f357a9332bbc?w=800&h=600&fit=crop",
      tags: ["AI Agents", "Google Gemini", "Product Deployment", "API Integration", "Audio Tech"],
      category: "AI Agent",
      featured: true,
      liveDemoLink: "https://blog-podcast-llm.streamlit.app/",
      sourceCodeLink: "https://github.com/AashutoshAgrawal/blog-podcast-llm",
      highlights: [
        "🚀 Product: Live Streamlit deployment → zero friction for users",
        "🤖 AI Pipeline: Firecrawl → Gemini summarization → Gemini TTS",
        "⚡ Speed: Blog URL → podcast audio in <30 seconds",
        "🎯 PM Decision: Google-only stack simplified architecture vs. multi-API complexity",
      ],
    },
    {
      id: 6,
